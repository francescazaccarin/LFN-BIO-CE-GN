...
\begin{itemize}
    ...
    Wrote and structured Intended Experiments and Appendix sections. Also contributed to revising the overall proposal structure, reference organization, and final document polishing.
...
It was also employed to refine the structure of the LaTeX source files and correct minor syntax issues, and used to improve the clarity and readability of the report text.
