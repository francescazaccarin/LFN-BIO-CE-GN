...
\begin{itemize}
    ...
    Development of the section related to the reachability transportation dataset, implementation of centrality and clustering analysis methods, and contribution to the methodology section.
\end{itemize}
